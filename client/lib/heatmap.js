        ...
        function WebGLHeatmap(_arg) {
            ...
            if (gradientTexture) {
                ...
                getColorFun = 'vec3 getColor(float intensity){\n' +
                    'vec3 blue = vec3(0.816, 0.8, 0.894);\n    ' +
                    'vec3 cyan = vec3(0.757, 0.737, 0.859);\n    ' +
                    'vec3 green = vec3(0.698, 0.671, 0.824);\n    ' +
                    'vec3 yellow = vec3(0.639, 0.604, 0.788);\n    ' +
                    'vec3 red = vec3(0.58, 0.541, 0.753);\n\n    ' +
                    'vec3 color = (\n            ' +
